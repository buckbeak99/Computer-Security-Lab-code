...
int main()
{
	...
	for(int sn=0;sn<v.size(); sn++){
		...
		for(int i=0;i<v[sn].length(); i++){
			...
			if(v[sn][i] == 'd') newStr += 'h';
			else if(v[sn][i] == 'm') newStr += 'r';
			else if(v[sn][i] == 'n') newStr += 'w';
			else if(v[sn][i] == 'c') newStr += 's';
			else if(v[sn][i] == 's') newStr += 'i';
			else if(v[sn][i] == 'l') newStr += 'o';
			else if(v[sn][i] == 'i') newStr += 'f';
			else if(v[sn][i] == 'f') newStr += 'l';
			else if(v[sn][i] == 'o') newStr += 'g';
			else if(v[sn][i] == 'h') newStr += 'n';
			else if(v[sn][i] == 'g') newStr += 'm';
			else if(v[sn][i] == 'z') newStr += 'b';
			else if(v[sn][i] == 'a') newStr += 'v';
			else if(v[sn][i] == 'y') newStr += 'd';
			else if(v[sn][i] == 't') newStr += 'c';
			else if(v[sn][i] == 'b') newStr += 'u';
			else if(v[sn][i] == 'r') newStr += 'x';
			else if(v[sn][i] == 'k') newStr += 'p';
			else if(v[sn][i] == 'p') newStr += 'y';
			else if(v[sn][i] == 'x') newStr += 'k';
			else if(v[sn][i] == 'j') newStr += 'q';
			else if(v[sn][i] == 'q') newStr += 'z';
			else if(v[sn][i] == 'w') newStr += 'j';
